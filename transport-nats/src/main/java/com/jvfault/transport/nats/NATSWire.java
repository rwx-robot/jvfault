...
/**
 * NATS wire 格式（JSON 载荷，与 redis/kafka/rmq 同构）。
 *
 * <p>NATS core request-reply 使用库自带 inbox 作为 reply subject，
 * wire body 仅携带 pattern / data / correlationId / error。
 *
 * @since v1.0.2 (2026)
 * @author jvfault team
 */
public class NATSWire {
    ...
    public static NATSWire from(Message message) {
        NATSWire wire = new NATSWire();
